// Max10_embedded_sys_max_niosv.v
...
`timescale 1 ps / 1 ps
module Max10_embedded_sys_max_niosv (
	...
	Max10_embedded_sys_max_niosv_hart #(
	...
	Max10_embedded_sys_max_niosv_irq_mapper irq_mapper (
		.clk           (clk),                      //       clk.clk
	...
	Max10_embedded_sys_max_niosv_irq_mapper irq_mapper_001 (
		.clk           (clk),                          //       clk.clk
		.reset         (reset_reset),                  // clk_reset.reset
	...
	Max10_embedded_sys_max_niosv_irq_mapper irq_mapper_002 (
		.clk           (clk),                          //       clk.clk
		.reset         (reset_reset),                  // clk_reset.reset
